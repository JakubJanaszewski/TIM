        ...
        if (!_context.Posts.Any())
        {
            _context.Posts.AddRange([
                ...
                new Post()
                {
                    ...
                    Tags = [politykaTag],
                    ApplicationUserId = user1.Id,
                    Coordinate = new Coordinate() { Latitude = 52, Longitude = 21}
                },
                new Post()
                {
                    ...
                    Coordinate = new Coordinate() { Latitude = 50, Longitude = 20 }
                },
                new Post()
                {
                    ...
                    ApplicationUserId = user2.Id,
                    Coordinate = new Coordinate() { Latitude = 52, Longitude = 20 }
                },
                new Post()
                {
                    ...
                    ApplicationUserId = user2.Id,
                    Coordinate = new Coordinate() { Latitude = 51, Longitude = 22 }
                }
            ]);
